...
import { SearchQuery, SearchResponse, SearchResult } from '@shared/types/search';
...
export class SearchService {
  ...
  private async searchByFilename(query: string, includeHidden: boolean, fileTypes: string[]): Promise<SearchResult[]> {
    try {
      // Build find command
  ...
  private async searchByContent(query: string, includeHidden: boolean, fileTypes: string[]): Promise<SearchResult[]> {
    try {
      // Build grep command
